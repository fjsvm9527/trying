...
if __name__ == "__main__":
    ...
    if train_df is not None:
        train_df.to_pickle(f"traindata_augmented_{CONFIG['window_size']}_market_new.pkl")
        valid_df.to_pickle(f"validdata_augmented_{CONFIG['window_size']}_market_new.pkl")